...
//  TODO (10) Remove the mWeatherDisplay TextView declaration
    ...
    TextView mDateTextView, mDescriptionTextView, mHighTextView, mLowTextView, mHumidityTextView, mWindTextView, mPressureTextView;
...
//      TODO (13) Find each of the TextViews by ID
        mDateTextView = findViewById(R.id.tv_date_text_view);
        mDescriptionTextView = findViewById(R.id.tv_description_text_view);
        mHighTextView = findViewById(R.id.tv_high_temperature_text_view);
        mLowTextView = findViewById(R.id.tv_low_temperature_text_view);
        mHumidityTextView = findViewById(R.id.tv_humidity_text_view);
        mWindTextView = findViewById(R.id.tv_wind_text_view);
        mPressureTextView = findViewById(R.id.tv_pressure_text_view);
...
//      TODO (33) Store a forecast summary in mForecastSummary
    ...
    public void onLoadFinished(@NonNull Loader<Cursor> loader, Cursor cursor) {
        ...
        long dateInMillis = cursor.getLong(INDEX_WEATHER_DATE);
        String dateText = SunshineDateUtils.getFriendlyDateString(this, dateInMillis, true);
        mDateTextView.setText(String.valueOf(dateText));

        int weatherId = cursor.getInt(INDEX_WEATHER_CONDITION_ID);
        String description = SunshineWeatherUtils.getStringForWeatherCondition(this, weatherId);
        mDescriptionTextView.setText(description);

        float highInCelsius = cursor.getFloat(INDEX_WEATHER_MAX_TEMP);
        String highString = SunshineWeatherUtils.formatTemperature(this, highInCelsius);
        mHighTextView.setText(highString);

        float lowInCelsius = cursor.getFloat(INDEX_WEATHER_MIN_TEMP);
